...
S-Recon is a Simple shell script (Bash) used to install the most important tools and requirements for your environment and save time in installing all these tools.
 ## Tools in S-Recon
...
----
## Requirements in S-Recon:heavy_check_mark:
